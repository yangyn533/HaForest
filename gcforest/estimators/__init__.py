...
from .sklearn_estimators import GCSGDClassifier,GCLR, GCExtraTreesClassifier, GCRandomForestClassifier, GCXGBClassifier, GCLGBClassifier, GCAdaBoostClassifier,GCDecisionTreeClassifier,GCGradientBoostingClassifier,GCRandomTreesEmbedding
...
def get_estimator_class(est_type):
    ...
    if est_type == "AdaBoostClassifier":
        return GCAdaBoostClassifier
    if est_type == "DecisionTreeClassifier":
        return GCDecisionTreeClassifier 
    if est_type == "GradientBoostingClassifier":
        return GCGradientBoostingClassifier 
    if est_type == "RandomTreesEmbedding":
        return GCRandomTreesEmbedding         
